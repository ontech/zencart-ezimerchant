...
// class methods
	...
	global $db, $insert_id, $order;
		...
		$query_addcapture = 0;
		$db->Execute("INSERT INTO ezi_order_mapping (eziorder_id, order_id, paymentmethod, amount, settleamount, paymentcompleted, paymentvoided, pendingreason, captureamount, transactionid, paymenttype, paypaltimestamp, cardtype, cardowner, cardnumber, cardexpiry, riskscore) VALUES ('".$_SESSION['eziorder_id']."', '".$insert_id."', '".$_SESSION['payment_eziinfo']['ezi_paymentmethod']."', '".$_SESSION['payment_eziinfo']['ezi_amount']."', '".$_SESSION['payment_eziinfo']['ezi_settleamount']."', '".$_SESSION['payment_eziinfo']['ezi_paymentcompleted']."', '".$_SESSION['payment_eziinfo']['ezi_paymentvoided']."', '".$_SESSION['payment_eziinfo']['ezi_pendingreason']."', '".$query_addcapture."', '".$_SESSION['payment_eziinfo']['ezi_transactionid']."', '".$_SESSION['payment_eziinfo']['ezi_paymenttype']."', '".$_SESSION['payment_eziinfo']['ezi_paymentdate']."', '".$_SESSION['payment_eziinfo']['cc_type']."', '".$_SESSION['payment_eziinfo']['cc_owner']."', '".$_SESSION['payment_eziinfo']['cc_number']."', '".$_SESSION['payment_eziinfo']['cc_expires']."', '".$_SESSION['payment_eziinfo']['ezi_riskscore']."' )" );

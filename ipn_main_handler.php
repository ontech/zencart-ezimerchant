...
$paramhash["RETURNURL"] = "http://".$_SERVER["HTTP_HOST"]."/index.php?main_page=checkout_complete&o={orderid}";
$paramhash["CANCELURL"] = "http://".$_SERVER["HTTP_HOST"]."/index.php?main_page=shopping_cart";
$paramhash["NOTIFYURL"] = "http://".$_SERVER["HTTP_HOST"]."/index.php?main_page=checkout_complete";
//$paramhash["TEMPLATEURL"] = "http://".$_SERVER["HTTP_HOST"].preg_replace("/".$_GET["main_page"]."/", "checkout_template", $_SERVER["REQUEST_URI"]);
$paramhash["CALCULATECALLBACKURL"] = "http://".$_SERVER["HTTP_HOST"]."/index.php?main_page=checkout_calculate";
$paramhash["LOGINCALLBACKURL"] = "http://".$_SERVER["HTTP_HOST"]."/index.php?main_page=checkout_login";
...
foreach($products as $product)
{
	...
	$paramhash["PRODUCTIMAGEURL(" .$itemidx . ")"] = 'http://'.$_SERVER["HTTP_HOST"]."/images/".$productimage;
...
$checkouturl = (string)$xml->entry->link["href"].'&pp=1';
